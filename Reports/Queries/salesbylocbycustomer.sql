SELECT salesrep_id, Rep, customer_id, customer_name
, ship_to_id, ship2_name, default_loc, SUM(NJ) AS NJ
, SUM(FL) AS FL, SUM(CA) AS CA , SUM(NJ)+Sum(FL)+SUM(CA) as Total 
...
GROUP BY salesrep_id, Rep, customer_id, customer_name, ship_to_id, ship2_name, default_loc
