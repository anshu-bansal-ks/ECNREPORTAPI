SELECT 
    ...
    oe_hdr.order_no,
    oe_hdr.po_no,
    -- CAST AS INT taaki Excel mein comma format automatic pakde
    CAST((oe_line.qty_ordered - oe_line.qty_on_pick_tickets - oe_line.qty_invoiced - oe_line.qty_canceled) AS INT) AS qty_bo
    {subQuery}
...
ORDER BY oe_hdr.ship2_name, oe_hdr.order_no, inv_mast.item_id